...
<img src="http://themes.semicolonweb.com/html/canvas/images/team/3.jpg" alt="John Doe" />
</div>
...
<div className="team team-list clearfix">
<div className="team-image">
<img src="http://themes.semicolonweb.com/html/canvas/images/team/2.jpg" alt="Nix Maxwell" />
</div>
<div className="team-desc">
...
<div className="team team-list clearfix">
<div className="team-image">
<img src="http://themes.semicolonweb.com/html/canvas/images/team/4.jpg" alt="John Doe" />
</div>
<div className="team-desc">
<div className="team-title"><h4>Jon Tableman</h4><span>CEO</span></div>
<div className="team-content">
<p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy dialogue assessment expert free-speech cornerstone disruptor freedom. Cesar Chavez empower.</p>
</div>
<a href="#" className="social-icon si-rounded si-small si-facebook">
...
<div className="team team-list clearfix">
<div className="team-image">
<img src="http://themes.semicolonweb.com/html/canvas/images/team/8.jpg" alt="Nix Maxwell" />
</div>
<div className="team-desc">
<div className="team-title"><h4>Mary Jane</h4><span>Support</span></div>
<div className="team-content">
<p>Eradicate invest honesty human rights accessibility theory of social change. Diversity experience in the field compassion, inspire breakthroughs planned giving.</p>
</div>
<a href="#" className="social-icon si-rounded si-small si-forrst">
