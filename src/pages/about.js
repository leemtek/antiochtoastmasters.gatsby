              ...
              <div className="flexslider">
                <div className="slider-wrap">
                  ...
                  <div className="col_one_fourth center" data-animate="bounceIn">
                    ...
                    <div className="counter counter-large" style={{color: `#3498db;`}}><span data-from="100" data-to="8465" data-refresh-interval="50" data-speed="2000"></span></div>
                    <h5>Clients Served</h5>
                  </div>
                  <div className="col_one_fourth center" data-animate="bounceIn" data-delay="200">
                    <i className="i-plain i-xlarge divcenter nobottommargin icon-code"></i>
                    <div className="counter counter-large" style={{color: `#e74c3c;`}}><span data-from="100" data-to="56841" data-refresh-interval="50" data-speed="2500"></span></div>
                    <h5>Lines of Code</h5>
                  </div>
                  <div className="col_one_fourth center" data-animate="bounceIn" data-delay="400">
                    <i className="i-plain i-xlarge divcenter nobottommargin icon-briefcase"></i>
                    <div className="counter counter-large" style={{color: `#16a085;`}}><span data-from="100" data-to="2154" data-refresh-interval="50" data-speed="3500"></span></div>
                    <h5>No. of Projects</h5>
                  </div>
                  <div className="col_one_fourth center col_last" data-animate="bounceIn" data-delay="600">
                    <i className="i-plain i-xlarge divcenter nobottommargin icon-cup"></i>
                    <div className="counter counter-large" style={{color: `#9b59b6;`}}><span data-from="100" data-to="874" data-refresh-interval="30" data-speed="2700"></span></div>
